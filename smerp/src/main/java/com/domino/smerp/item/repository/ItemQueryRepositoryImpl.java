...
public class ItemQueryRepositoryImpl implements ItemQueryRepository {
    ...
    private BooleanExpression groupName1Eq(String groupName1) {
        return (groupName1 == null || groupName1.isEmpty()) ? null : QItem.item.groupName1.eq(groupName1);
    }

    // 품목 품목그룹2 검색
    private BooleanExpression groupName2Eq(String groupName2) {
        return (groupName2 == null || groupName2.isEmpty()) ? null : QItem.item.groupName2.eq(groupName2);
    }

    // 품목 품목그룹3 검색
    private BooleanExpression groupName3Eq(String groupName3) {
        return (groupName3 == null || groupName3.isEmpty()) ? null : QItem.item.groupName3.eq(groupName3);
    }
}
